...
private:
	...
	static constexpr char INITIALIZE_COMMAND			= 0xE1;		// Intialize sensor command.
	static constexpr char TRIGGER_MEASUREMENT_COMMAND	= 0xAC;		// Trigger sensor measurement command.
	static constexpr char SOFT_RESET_COMMAND			= 0xBA;		// Reset sensor command.
